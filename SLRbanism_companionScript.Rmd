...
Your_scopus_api_key <- readLines(con = "ignore.md")
```
...
utf8tolatin1(here("data", "scopus200.ris"), 
             here("data", "scopus200-latin1.ris"))

# utf8tolatin1 fix taken from https://github.com/mjwestgate/revtools/issues/42

scopus_data <- read_bibliography(here("data", "scopus200-latin1.ris"))

wos_data <-read_bibliography(here("Data", "lprln.bib"))
```
...
There are $nrow(unique_references)$ unique references.
