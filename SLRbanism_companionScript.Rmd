...
>>>>>>> 934540d6d89079c217122bd5e570a672fec5cc07
```
...
prisma(found = nrow(all_references),
       ...
       screened = nrow(all_unique_references), 
       screen_exclusions = 0, 
       full_text = nrow(all_unique_references),
       full_text_exclusions = 0, 
       qualitative = nrow(all_unique_references), 
       quantitative = nrow(all_unique_references),
...
ggsave(here("figures", "prisma_diagram.jpeg"), plot = prisma_plot, width = 10, height =6)
install.packages("webshot")
library(webshot)
webshot::webshot(here("figures", "prisma_diagram.jpeg"), prisma_plot)
```
