...
::: note
The same workflow applies to data obtained from other platforms such as Scopus. Note that the column names need to be adjusted accordingly.
:::

## Pre-processing task 1: Extracting text from PDF files
