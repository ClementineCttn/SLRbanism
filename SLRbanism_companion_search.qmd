...
```{r}
#create a vector with the doi's of 
# van Marissing et al. (2006) and Wu and Zang (2022)
target_references <- c(
  "doi.org/10.1016/j.cities.2005.11.001",
  "doi.org/10.1177/03091325211062171"
  )

# Let's test whether they are present or not our reference list
 target_references %in% all_unique_references$doi
